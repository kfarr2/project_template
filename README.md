...
Start a new Django project using this template
    ...
    project_name="lame"
    django-admin.py startproject --name=project_name.conf,README.md,Makefile,MANIFEST.in --extension=template,py --template=https://github.com/kfarr2/project_template/archive/master.zip $project_name
